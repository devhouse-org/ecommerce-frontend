...
const AboutUs = () => {
  return (
    <div className="bg-white ">
      <header className="bg-black/95 text-white text-center pt-32 pb-12">
      ...
      <section className="bg-black/95 text-white py-12 px-4">
      ...
      <section className="bg-black/95 text-black/95 text-center py-12 px-4">
        <h2 className="text-2xl font-bold text-white">Patient Testimonials</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mt-8 max-w-5xl mx-auto">
          <div className="p-4 shadow-lg rounded-lg bg-white hover:bg-gray-500 transition-colors">
